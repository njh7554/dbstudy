...
SELECT 
  ...
  FROM
       EMPLOYEES
 WHERE 
       DEPARTMENT_ID IN(50) AND SALARY < 5000;
...
SELECT
  ...
  FROM 
       EMPLOYEES
 WHERE 
       FIRST_NAME LIKE 'Steven%' AND LAST_NAME LIKE 'King%'; 
...
SELECT COMMITSSION_PCT, COMMISSION_PCT * SALARY
  FROM EMPLOYEES
 WHERE COMMITSSION_PCT IS NOT NULL;
