...
/*
    ...
    5. 테이블 이름 : ALTER TABLE 테이블명 RENAME TO 테이블명
*/
...
-- 2. COSTOMER_TBL 테이블에서 나이(AGE) 칼럼을 삭제하시오.
...
-- 4. CUSTOMER_TBL 테이블의 고객명(NAME) 칼럼의 이름을 CUST_NAME으로 변경하시오
ALTER TABLE CUSTOMER_TBL
...
-- 6. BANK_TBL 테이블의 BANK_NAME 칼럼을 NOT NULL 제약조건을 추가하시오.
ALTER TABLE BANK_TBL 
...
ALTER TABLE CUSTOMER_TBL
    ...
    -- 기존 제약조건이 NOT NULL일 경우 NULL로 변경할 때에는 NULL을 명시해준다.
