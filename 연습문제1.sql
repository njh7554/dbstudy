...
CREATE TABLE MEMBER_TBL (
    ...
    MEMBER_PW    VARCHAR2(30 BYTE)  NOT NULL,
    MEMBER_POINT NUMBER             NULL,
    GRADE        VARCHAR2(10 BYTE)  NULL CHECK(GRADE = 'VIP' OR GRADE = 'GOLD' OR GRADE = 'SILVER' OR GRADE = 'BRONZE'),
...
ALTER TABLE MEMBER_TBL
  ADD ADRESS VARCHAR2(200 BYTE) NULL;
ALTER TABLE MEMBER_TBL
...
ALTER TABLE MEMBER_TBL
RENAME COLUMN MEMBER_PW TO PWD;
